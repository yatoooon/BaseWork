...
import ${baselibraryName}.base.BaseFragment
import ${baselibraryName}.di.component.AppComponent
import ${baselibraryName}.utils.ArmsUtils
 ...
 * }
 */
class ${pageName}Fragment : BaseFragment<${pageName}Presenter,,${pageName}Activity>() , ${pageName}Contract.View{
    companion object {
