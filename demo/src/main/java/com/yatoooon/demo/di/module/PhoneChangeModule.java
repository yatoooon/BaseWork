...
import com.yatoooon.demo.mvp.model.PhoneChangeModel;
 ...
 */
@Module
public abstract class PhoneChangeModule {

    @Binds
    abstract PhoneChangeContract.Model bindPhoneChangeModel(PhoneChangeModel model);
}