 ...
 */
@ActivityScope
public class PhoneChangePresenter extends BasePresenter<PhoneChangeContract.Model, PhoneChangeContract.View> {
    @Inject
    ...
    @Inject
    public PhoneChangePresenter(PhoneChangeContract.Model model, PhoneChangeContract.View rootView) {
