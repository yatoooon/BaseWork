...
import com.yatoooon.demo.app.dialog.DateDialog;
...
import com.yatoooon.demo.app.dialog.MessageDialog;
import com.yatoooon.demo.app.dialog.PayPasswordDialog;
import com.yatoooon.demo.app.dialog.SafeDialog;
import com.yatoooon.demo.app.dialog.SelectDialog;
import com.yatoooon.demo.app.dialog.ShareDialog;
import com.yatoooon.demo.app.dialog.TimeDialog;
...
public class DialogActivity extends MyActivity {
    ...
    AppCompatButton btnDialogInput;
    @BindView(R.id.btn_dialog_bottom_menu)
    AppCompatButton btnDialogBottomMenu;
    @BindView(R.id.btn_dialog_center_menu)
    AppCompatButton btnDialogCenterMenu;
    @BindView(R.id.btn_dialog_single_select)
    AppCompatButton btnDialogSingleSelect;
    @BindView(R.id.btn_dialog_more_select)
    AppCompatButton btnDialogMoreSelect;
    @BindView(R.id.btn_dialog_succeed_toast)
    AppCompatButton btnDialogSucceedToast;
    @BindView(R.id.btn_dialog_fail_toast)
    AppCompatButton btnDialogFailToast;
    @BindView(R.id.btn_dialog_warn_toast)
    AppCompatButton btnDialogWarnToast;
    @BindView(R.id.btn_dialog_wait)
    AppCompatButton btnDialogWait;
    @BindView(R.id.btn_dialog_pay)
    AppCompatButton btnDialogPay;
    @BindView(R.id.btn_dialog_address)
    AppCompatButton btnDialogAddress;
    @BindView(R.id.btn_dialog_date)
    AppCompatButton btnDialogDate;
    @BindView(R.id.btn_dialog_time)
    AppCompatButton btnDialogTime;
    @BindView(R.id.btn_dialog_update)
    AppCompatButton btnDialogUpdate;
    @BindView(R.id.btn_dialog_share)
    AppCompatButton btnDialogShare;
    @BindView(R.id.btn_dialog_safe)
