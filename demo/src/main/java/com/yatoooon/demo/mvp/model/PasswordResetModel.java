 ...
 */
@ActivityScope
public class PasswordResetModel extends BaseModel implements PasswordResetContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PasswordResetModel(IRepositoryManager repositoryManager) {
